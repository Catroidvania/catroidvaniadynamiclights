...
import net.minecraft.common.entity.monster.EntityBlaze;
import net.minecraft.common.entity.monster.EntityCreeper;
import net.minecraft.common.entity.other.*;
import net.minecraft.common.entity.player.EntityPlayer;
import net.minecraft.common.item.Item;
import net.minecraft.common.item.ItemBlock;
import net.minecraft.common.item.ItemStack;
import net.minecraft.common.level.World;
